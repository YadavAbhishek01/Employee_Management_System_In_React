...
const Complete = ({task}) => {
  return (
    <div className='flex-shrink-0 p-5  h-full w-[500px] bg-sky-300 rounded-2xl '>
    ...
    <div className="  flex mt-20 w-full items-center justify-center gap-5">
            <button className=" bg-green-700 rounded-2xl px-5  py-3 w-full text-base  font-semibold">Completed</button> 
